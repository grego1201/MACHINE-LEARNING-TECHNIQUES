...
def tree_regressor(data, split_yer, max_depth, features_selected, feature_regression, city, verbose = False):
        #3. Build the model
...
"""
def randomforest(data, max_depth, features_selected, feature_regresion, city, verbose = False):
"""  